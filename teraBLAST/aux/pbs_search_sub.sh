...
mpirun -np 100 /bin/bash /scratch/externe/ens/frochajimenezvi/mpi/mpi.sh 0 /scratch/externe/ens/frochajimenezvi/mpi/alpha/jobs.@.tsv 1> ${OUTPUT}.pbs 2>&1 

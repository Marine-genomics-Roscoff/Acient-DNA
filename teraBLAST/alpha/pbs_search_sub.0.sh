...
#mpirun -np 100 
#exec mpirun 
/bin/bash /scratch/externe/ens/frochajimenezvi/mpi/mpi.sh 0 /scratch/externe/ens/frochajimenezvi/mpi/alpha/jobs.0.tsv 1> ${OUTPUT}.pbs 2>&1 
